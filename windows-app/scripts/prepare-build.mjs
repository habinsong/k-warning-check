...
await writeFile(
  ...
  `${JSON.stringify(
    {
      name: 'k-warning-check-desktop-windows',
      version: workspacePackage.version,
      kwcDesktopBuildId: buildId,
      description: 'K-WarningCheck Desktop for Windows',
...
await writeFile(
  ...
  'electron windows-app/.app-build/electron/main.mjs 명령으로 스테이징된 Windows 앱을 실행할 수 있습니다.\n',
  'utf8',
)
